...
> **Public Beta 0.1.0-beta.2.** A trial release. Try it on a copy of your artwork. Keep Illustrator in the foreground with the screen unlocked. For what is covered, see [Beta scope](../README.en.md#beta-scope).
